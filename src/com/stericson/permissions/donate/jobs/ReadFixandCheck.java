...
public class ReadFixandCheck extends AsyncJob<Result>
{
    public static final int READFIXANDCHECK = 234;

    private Context context;
    private JobCallback jcb;

	public ReadFixandCheck(BaseActivity jcb, boolean show)
	{
		super(jcb, R.string.loadingPackages, show, false);
        this.context = jcb;
        this.jcb = jcb;
    ...
    Result handle()
    {
        return new ReadFixandCheckTask(this).executeTask();
    }
    ...
    {
	    jcb.jobCallBack(result, READFIXANDCHECK);
    }
}
